...
class Peminjaman_model extends CI_Model{
  ...
  {
    $this->db->select('
      id_peminjaman, tgl_peminjaman, tgl_kembali, peminjaman.anggota_id, peminjaman.arsip_id, peminjaman.is_kembali, peminjaman.created_at, peminjaman.created_by,
  ...
  function get_all_by_bagian()
  {
    ...
    $this->db->where('peminjaman.cabang_id', $this->session->cabang_id);
    $this->db->where('peminjaman.divisi_id', $this->session->divisi_id);
    $this->db->where('peminjaman.bagian_id', $this->session->bagian_id);
  ...
  function get_all_combobox_arsip_peminjaman_by_bagian()
  {
    $this->db->join('arsip', 'peminjaman.arsip_id = arsip.id_arsip');

...
class Divisi_model extends CI_Model
{
  ...
  function get_bagian_combobox_update($divisi_id)
  {
  ...
  function get_bagian_all_combobox_by_instansi($instansi_id)
  {
  ...
  function get_all_bagian_combobox_by_divisi($divisi_id)
  {
    $this->db->select('
  ...
  function get_all_combobox_bagian_by_divisi($divisi_id)
  {
    $this->db->select('
      id_bagian, bagian.bagian_name, bagian.instansi_id,
      instansi.instansi_name, 
  ...
  function get_all_deleted_by_cabang()
  {
    ...
    $this->db->where('divisi.instansi_id', $this->session->instansi_id);
    $this->db->where('divisi.cabang_id', $this->session->cabang_id);
    $this->db->where('is_delete_divisi', '1');
  ...
  function get_divisi_by_cabang_combobox($cabang_id)
  {
    ...
    if ($sql->num_rows() > 0) {
      ...
      $result['-'] = '- Belum Ada Program Studi -';
    }
    return $result;
  }

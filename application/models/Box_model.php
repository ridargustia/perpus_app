...
class Box_model extends CI_Model
{
  ...
  {
    $this->db->select('
      box.id_box, box.box_name, cabang.cabang_name, instansi.instansi_name, box.created_by as created_by_box, divisi.divisi_name
    ');
    
    $this->db->join('instansi', 'box.instansi_id = instansi.id_instansi', 'left');
    $this->db->join('cabang', 'box.cabang_id = cabang.id_cabang', 'left');
    $this->db->join('divisi', 'box.divisi_id = divisi.id_divisi', 'left');
  ...
  function get_all_by_cabang()
  {
    ...
    $this->db->where('box.instansi_id', $this->session->instansi_id);
    $this->db->where('box.cabang_id', $this->session->cabang_id);
    $this->db->where('is_delete_box', '0');
  ...
  function get_all_by_divisi()
  {
    ...
    $this->db->where('box.instansi_id', $this->session->instansi_id);
    $this->db->where('box.cabang_id', $this->session->cabang_id);
    $this->db->where('box.divisi_id', $this->session->divisi_id);
    $this->db->where('is_delete_box', '0');
  ...
  function get_box_by_divisi_combobox($divisi_id)
  {
  ...
  {
    $this->db->join('divisi', 'box.divisi_id = divisi.id_divisi');

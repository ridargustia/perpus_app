...
class Map_model extends CI_Model
{
  ...
  {
    $this->db->select('
      map.id_map, map.map_name, cabang.cabang_name, instansi.instansi_name, map.created_by as created_by_map, divisi.divisi_name
    ');
    
    $this->db->join('instansi', 'map.instansi_id = instansi.id_instansi', 'left');
    $this->db->join('cabang', 'map.cabang_id = cabang.id_cabang', 'left');
    $this->db->join('divisi', 'map.divisi_id = divisi.id_divisi', 'left');
  ...
  function get_all_by_cabang()
  {
    ...
    $this->db->where('map.instansi_id', $this->session->instansi_id);
    $this->db->where('map.cabang_id', $this->session->cabang_id);
    $this->db->where('is_delete_map', '0');
  ...
  function get_all_by_divisi()
  {
    ...
    $this->db->where('map.instansi_id', $this->session->instansi_id);
    $this->db->where('map.cabang_id', $this->session->cabang_id);
    $this->db->where('map.divisi_id', $this->session->divisi_id);
    $this->db->where('is_delete_map', '0');
  ...
  function get_map_by_divisi_combobox($divisi_id)
  {
  ...
  {
    $this->db->join('divisi', 'map.divisi_id = divisi.id_divisi');

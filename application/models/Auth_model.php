...
class Auth_model extends CI_Model
{
  ...
  function get_all_by_divisi()
  {
    ...
    $this->db->where('users.divisi_id', $this->session->divisi_id);
    $this->db->where('users.usertype_id >', '3');
    $this->db->where('users.usertype_id !=', '5');
    $this->db->where('is_delete', '0');
  ...
  function get_all_combobox_change_password_by_divisi($divisi_id)
  {
    $this->db->join('divisi', 'users.divisi_id = divisi.id_divisi');
  ...
  function get_all_combobox_by_bagian($bagian_id)
  {
    $this->db->join('bagian', 'users.bagian_id = bagian.id_bagian');    

    $this->db->where('users.bagian_id', $bagian_id);
    // $this->db->where('divisi.instansi_id', $this->session->instansi_id);
    // $this->db->where('usertype_id', '4');
  ...
  function get_user_by_bagian_combobox($bagian_id)
  {

...
class Arsip extends CI_Controller
{
  ...
  function cari_arsip()
  {
    ...
    $bagian_id    = $this->input->get('bagian_id');
    ...
    $this->data['bagian']     = $this->Bagian_model->get_by_id($bagian_id);
    ...
    if (is_grandadmin()) {
      ...
      if ($search_form == NULL and $bagian_id == NULL) {
        $this->data['hasil_pencarian']  = $this->Arsip_model->get_all_by_instansi();
      }
      // jika form pencarian KOSONG dan CABANG DIISI
      elseif ($search_form == NULL and $bagian_id != NULL) {
        $this->data['hasil_pencarian']  = $this->Arsip_model->get_all_by_instansi_with_searchFormNull_and_bagianNotNull($bagian_id);
      }
      // jika form pencarian DIISI dan CABANG KOSONG
      elseif ($search_form != NULL and $bagian_id == NULL) {
        $this->data['hasil_pencarian']  = $this->Arsip_model->get_all_by_instansi_with_searchFormNotNull_and_bagianNull($search_form);
      }
      // jika form pencarian DIISI dan CABANG DIISI
      elseif ($search_form != NULL and $bagian_id != NULL) {
        $this->data['hasil_pencarian']  = $this->Arsip_model->get_all_by_instansi_with_searchFormNotNull_and_bagianNotNull($search_form, $bagian_id);
      }
    }

...
class Laporan extends CI_Controller
{
  ...
  {
    if (is_grandadmin()) {
      $get_all = $this->Arsip_model->get_all();
    } elseif (is_masteradmin()) {
      $get_all = $this->Arsip_model->get_all_by_instansi();
    } elseif (is_superadmin()) {
      $get_all = $this->Arsip_model->get_all_by_cabang();
    } elseif (is_admin()) {
      $get_all = $this->Arsip_model->get_all_by_divisi();
    }

...
class Auth extends CI_Controller
{
  ...
  function update($id)
  {
    ...
    if (is_grandadmin()) {
      ...
      $this->data['get_all_combobox_bagian']       = $this->Bagian_model->get_all_combobox_update($this->data['user']->divisi_id);
    } elseif (is_masteradmin()) {
  ...
  function update_profile($id)
  {
    ...
    if ($id != $this->session->id_users || is_user()) {
  ...
  function pilih_user()
  {
    $this->data['user'] = $this->Auth_model->get_user_by_bagian_combobox($this->uri->segment(4));

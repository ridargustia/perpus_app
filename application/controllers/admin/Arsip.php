...
class Arsip extends CI_Controller
{
  ...
  function index()
  {
    ...
    if (is_grandadmin()) {
      ...
      $this->data['get_all'] = $this->Arsip_model->get_all_by_bagian();
  ...
  function detail($id)
  {
    ...
    if (is_pegawai() && $row->bagian_id != $this->session->bagian_id) {
      $this->session->set_flashdata('message', '<div class="alert alert-danger">Anda tidak berhak melihat data orang lain</div>');
      redirect('admin/arsip');
  ...
  function create()
  {
    ...
    if (is_grandadmin()) {
      ...
      $this->data['get_all_combobox_bagian']    = $this->Divisi_model->get_all_combobox_bagian_by_divisi($this->session->divisi_id);
      $this->data['get_all_combobox_lokasi']    = $this->Lokasi_model->get_all_combobox_by_divisi($this->session->divisi_id);
      // $this->data['get_all_combobox_user']      = $this->Auth_model->get_all_combobox_by_divisi($this->session->divisi_id);
      $this->data['get_all_combobox_rak']       = $this->Rak_model->get_all_combobox_by_divisi($this->session->divisi_id);
      $this->data['get_all_combobox_box']       = $this->Box_model->get_all_combobox_by_divisi($this->session->divisi_id);
      $this->data['get_all_combobox_map']       = $this->Map_model->get_all_combobox_by_divisi($this->session->divisi_id);
      $this->data['get_all_combobox_baris']     = $this->Baris_model->get_all_combobox_by_divisi($this->session->divisi_id);
    } elseif (is_pegawai()) {
      $this->data['get_all_combobox_lokasi']    = $this->Lokasi_model->get_all_combobox_by_divisi($this->session->divisi_id);
      // $this->data['get_all_combobox_user']      = $this->Auth_model->get_all_combobox_by_divisi($this->session->divisi_id);
      $this->data['get_all_combobox_user']      = $this->Auth_model->get_all_combobox_by_bagian($this->session->bagian_id);
      $this->data['get_all_combobox_rak']       = $this->Rak_model->get_all_combobox_by_divisi($this->session->divisi_id);
      $this->data['get_all_combobox_box']       = $this->Box_model->get_all_combobox_by_divisi($this->session->divisi_id);
      $this->data['get_all_combobox_map']       = $this->Map_model->get_all_combobox_by_divisi($this->session->divisi_id);
      $this->data['get_all_combobox_baris']     = $this->Baris_model->get_all_combobox_by_divisi($this->session->divisi_id);
  ...
  function update($id)
  {
    ...
    if (is_pegawai() && $row->bagian_id != $this->session->bagian_id) {
      ...
      if (is_grandadmin()) {
        ...
        $this->data['get_all_combobox_bagian']      = $this->Bagian_model->get_all_combobox_update($this->data['arsip']->divisi_id);
        ...
        $this->data['get_all_combobox_map']         = $this->Map_model->get_all_combobox_by_divisi($this->session->divisi_id);
        $this->data['get_all_combobox_baris']       = $this->Baris_model->get_all_combobox_by_divisi($this->session->divisi_id);
      } elseif (is_superadmin() or is_admin() or is_pegawai()) {
        $this->data['get_all_combobox_divisi']      = $this->Divisi_model->get_all_combobox_by_cabang($this->session->cabang_id);
        $this->data['get_all_combobox_bagian']      = $this->Bagian_model->get_all_combobox_by_divisi($this->session->divisi_id);
        $this->data['get_all_combobox_lokasi']      = $this->Lokasi_model->get_all_combobox_by_divisi($this->session->divisi_id);
        $this->data['get_all_combobox_user']        = $this->Auth_model->get_all_combobox_by_bagian($this->session->bagian_id);
  ...
  public function ajax_delete($id)
  {
    ...
    if (is_pegawai() && $row->created_by_arsip != $this->session->username) {
      $this->session->set_flashdata('message', '<div class="alert alert-danger">Anda tidak berhak mengubah data orang lain</div>');
      redirect('admin/arsip');
    } else {
      if ($row) {
  ...
  function deleted_list()
  {
    ...
    if (is_grandadmin()) {
      ...
      $this->data['get_all_deleted'] = $this->Arsip_model->get_all_deleted_by_bagian();
      $this->load->view('back/arsip/arsip_deleted_list_pegawai', $this->data);
    }
  }
  ...
  function check_no_arsip()
  {
    ...
    $check_no_arsip     = $this->Arsip_model->get_no_arsip_by_divisi($no_arsip, $divisi_id, $cabang_id, $instansi_id);
  ...
  function check_arsip_name()
  {
    ...
    $check_arsip_name     = $this->Arsip_model->get_arsip_name_by_divisi($arsip_name, $divisi_id, $cabang_id, $instansi_id);

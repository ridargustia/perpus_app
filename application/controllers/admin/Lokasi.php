...
class Lokasi extends CI_Controller
{
  ...
  function create_action()
  {
    ...
    if (is_grandadmin()) {
      ...
      $this->data['check_by_name']  = $this->Lokasi_model->check_by_name_and_instansi_and_cabang_and_divisi($this->input->post('lokasi_name'), $instansi_id, $cabang_id, $divisi_id);
    } elseif (is_masteradmin()) {

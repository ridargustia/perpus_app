            ...
            <table id="dataTable" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                foreach ($get_all as $data) {
                  // action
                  $edit = '<a href="' . base_url('admin/cabang/update/' . $data->id_cabang) . '" class="btn btn-warning" title="Ubah Cabang"><i class="fa fa-pencil"></i></a>';
                  $delete = '<a href="' . base_url('admin/cabang/delete/' . $data->id_cabang) . '" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger" title="Hapus Cabang"><i class="fa fa-trash"></i></a>';
                ?>
                  <tr>

            ...
            <table id="dataTable" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                foreach ($get_all as $data) {
                  // action
                  $edit = '<a href="' . base_url('admin/baris/update/' . $data->id_baris) . '" class="btn btn-warning" title="Ubah Baris"><i class="fa fa-pencil"></i></a>';
                  $delete = '<a href="' . base_url('admin/baris/delete/' . $data->id_baris) . '" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger" title="Hapus Baris"><i class="fa fa-trash"></i></a>';
                ?>
                  <tr>

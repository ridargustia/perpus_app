            ...
            <table id="dataTable" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $no = 1; foreach($get_all_deleted as $data){
                  // action
                  $restore = '<a href="'.base_url('admin/baris/restore/'.$data->id_baris).'" class="btn btn-sm btn-primary" title="Restore Baris"><i class="fa fa-refresh"></i></a>';
                  $delete = '<a href="'.base_url('admin/baris/delete_permanent/'.$data->id_baris).'" onClick="return confirm(\'Are you sure?\');" class="btn btn-sm btn-danger" title="Hapus Permanen"><i class="fa fa-remove"></i></a>';
                ?>
                  <tr>

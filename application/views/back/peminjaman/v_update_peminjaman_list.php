    ...
    <table class="table">
        ...
        <tbody>
            ...
            foreach ($buku_dipinjam as $data) {
                ...
                //TODO Tombol action
                $kembalikan = '<a href="' . base_url('admin/pengembalian/update_verifikasi_buku/' . $pengembalian->id_pengembalian . '/' . $data->id_peminjaman . '/' . $subtotal_denda) . '" class="btn btn-sm btn-info" title="Kembalikan Buku"><i class="fa fa-refresh"></i></a>';
            ?>
                <tr>

            ...
            <table id="dataTable" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                foreach ($get_all as $data) {
                  // action
                  $edit = '<a href="' . base_url('admin/rak/update/' . $data->id_rak) . '" class="btn btn-warning" title="Ubah Rak"><i class="fa fa-pencil"></i></a>';
                  $delete = '<a href="' . base_url('admin/rak/delete/' . $data->id_rak) . '" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger" title="Hapus Rak"><i class="fa fa-trash"></i></a>';
                ?>
                  <tr>

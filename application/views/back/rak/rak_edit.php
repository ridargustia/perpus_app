      ...
      <div class="box box-primary">
        ...
        <div class="box-body">        
            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="form-group"><label>Fakultas (*)</label>
                  <?php echo form_dropdown('', $get_all_combobox_cabang, $rak->cabang_id, $cabang_id) ?>
                </div>
              </div>
              <div class="col-sm-4">
                <div class="form-group"><label>Program Studi (*)</label>
                  <?php echo form_dropdown('', $get_all_combobox_divisi, $rak->divisi_id, $divisi_id) ?>
                </div>
              </div>
            </div>
          ...
          <div class="form-group"><label>Nama Rak</label>
            <?php echo form_input($rak_name, $rak->rak_name) ?>
          </div>
        </div>
        <?php echo form_input($id_rak, $rak->id_rak) ?>

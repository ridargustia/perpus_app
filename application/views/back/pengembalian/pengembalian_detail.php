        ...
        <section class="content">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <?php
                    foreach ($get_pengembalian as $data) {
                        //TODO Tombol Action
                        $edit = '<a href="' . base_url('admin/pengembalian/update/' . $data->id_pengembalian) . '" class="btn btn-sm btn-warning" title="Ganti Buku"><i class="fa fa-pencil"></i> Ganti Buku</a>';
                        $delete = '<a href="' . base_url('admin/pengembalian/delete/' . $data->id_pengembalian) . '" onClick="return confirm(\'Apakah anda yakin ingin menghapus data?\');" class="btn btn-sm btn-danger" title="Hapus Data"><i class="fa fa-trash"></i> Hapus</a>';
                    ?>
                        <div class="box box-primary">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <?php
                                        //? Jika memiliki cover buku
                                        if ($data->cover_buku != NULL) {
                                        ?>
                                        ...
                                        <?php
                                            //? Jika tidak memiliki cover buku
                                        } else {
                                        ?>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Penulis</td>
                                                    <td>:</td>
                                                    <td class="text-left"><?php echo $data->penulis_buku ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Penerbit</td>
                                                    <td>:</td>
                                                    <td class="text-left"><?php echo $data->penerbit ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Kota Penerbit</td>
                                                    <td>:</td>
                                                    <td class="text-left"><?php echo $data->kota_penerbit ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Tahun Terbit</td>
                                                    <td>:</td>
                                                    <td class="text-left"><?php echo $data->tahun_terbit ?></td>
                                                </tr>
                                                <tr>

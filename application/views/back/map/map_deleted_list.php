            ...
            <table id="dataTable" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $no = 1; foreach($get_all_deleted as $data){
                  // action
                  $restore = '<a href="'.base_url('admin/map/restore/'.$data->id_map).'" class="btn btn-sm btn-primary" title="Restore Map"><i class="fa fa-refresh"></i></a>';
                  $delete = '<a href="'.base_url('admin/map/delete_permanent/'.$data->id_map).'" onClick="return confirm(\'Are you sure?\');" class="btn btn-sm btn-danger" title="Hapus Permanen"><i class="fa fa-remove"></i></a>';
                ?>
                  <tr>

            ...
            <table id="dataTable" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                foreach ($get_all as $data) {
                  // action
                  $edit = '<a href="' . base_url('admin/lokasi/update/' . $data->id_lokasi) . '" class="btn btn-warning" title="Ubah Lokasi"><i class="fa fa-pencil"></i></a>';
                  $delete = '<a href="' . base_url('admin/lokasi/delete/' . $data->id_lokasi) . '" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger" title="Hapus Lokasi"><i class="fa fa-trash"></i></a>';
                ?>
                  <tr>

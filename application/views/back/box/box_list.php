            ...
            <table id="dataTable" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                foreach ($get_all as $data) {
                  // action
                  $edit = '<a href="' . base_url('admin/box/update/' . $data->id_box) . '" class="btn btn-warning" title="Ubah Box"><i class="fa fa-pencil"></i></a>';
                  $delete = '<a href="' . base_url('admin/box/delete/' . $data->id_box) . '" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger" title="Hapus Box"><i class="fa fa-trash"></i></a>';
                ?>
                  <tr>
                    ...
                    <td style="text-align: center"><?php echo $data->created_by_box ?></td>

    ...
    <section class="content">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">          
            ...
            <div class="row">
              <div class="col-sm-4">
                <div class="form-group"><label>Perguruan Tinggi (*)</label>
                  <?php echo form_dropdown('', $get_all_combobox_instansi, $box->instansi_id, $instansi_id) ?>
                </div>
              </div>
              <div class="col-sm-4">
                <div class="form-group"><label>Fakultas (*)</label>
                  <?php echo form_dropdown('', $get_all_combobox_cabang, $box->cabang_id, $cabang_id) ?>
                </div>
              </div>
              <div class="col-sm-4">
                <div class="form-group"><label>Program Studi (*)</label>
                  <?php echo form_dropdown('', $get_all_combobox_divisi, $box->divisi_id, $divisi_id) ?>
                </div>
              </div>
            </div>
          ...
          <div class="form-group"><label>Nama Box</label>
            <?php echo form_input($box_name, $box->box_name) ?>
          </div>
        </div>
        <?php echo form_input($id_box, $box->id_box) ?>

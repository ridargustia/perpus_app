            ...
            <table id="dataTable" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php $no = 1; foreach($get_all as $data){
                  // action
                  $edit = '<a href="'.base_url('admin/bagian/update/'.$data->id_bagian).'" class="btn btn-warning" title="Ubah Divisi"><i class="fa fa-pencil"></i></a>';
                  $delete = '<a href="'.base_url('admin/bagian/delete/'.$data->id_bagian).'" onClick="return confirm(\'Are you sure?\');" class="btn btn-danger" title="Hapus Divisi"><i class="fa fa-trash"></i></a>';
                ?>
                  <tr>

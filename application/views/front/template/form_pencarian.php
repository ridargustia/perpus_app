    ...
    <div class="box box-warning box-solid">
      ...
      <div class="box-body">
        ...
        ?>
          ...
          if ($get_all_bagian == NULL) {
            echo "Silahkan input divisi terlebih dahulu melalui ADMINISTRATOR";
          } else {
            foreach ($get_all_bagian as $bagian) {
            ?>
              <div class="pretty p-icon p-smooth">
                <input type="radio" name="bagian_id" value="<?php echo $bagian->id_bagian ?>" />
                <div class="state p-success">
                  <i class="icon fa fa-check"></i>
                  <label><?php echo $bagian->bagian_name ?></label>
                </div>
              </div>
        <?php }
          }
